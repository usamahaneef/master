                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="email" name="email" class="form-control"
                                                                       value="{{$hospital->email ,old('email')}}"
                                                                       placeholder="Enter ">
                                                                @error('email')
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="contact" name="contact" class="form-control"
                                                                       value="{{$hospital->contact ,old('contact')}}"
                                                                       placeholder="Enter ">
                                                                @error('contact')
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="1" id="address" name="address"
                                                                  placeholder="Enter ">{{$hospital->address ,old('address')}}</textarea>
                                                        @error('address')
                                                        <span
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group float-right">
                                                      ...
                                                      <input type="checkbox" id="status" name="status"
                                                             ...
                                                             value="1"
                                                             {{$hospital->status == 1?'checked="checked"':''}}>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
